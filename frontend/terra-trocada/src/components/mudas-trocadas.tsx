...
const MinhasMudasTrocadas: React.FC<Props> = ({ mudasTrocadas }) => {
  ...
  return (
    <div>
      <h1 className="mb-4 text-primary text-center">Mudas Trocadas</h1>
            ...
            <div className="card">
              ...
              <div className="card-body">
                ...
                <div style={{ display: 'flex', alignItems: 'center' }}>
                  ...
                  {ratings[`muda-${index}`] > 0 && <span style={{ marginLeft: '10px' }}>Avaliação: {ratings[`muda-${index}`]}</span>}
                </div>
                {comments[`muda-${index}`] && (
                  <div className="mt-2">
                    <strong>Comentário:</strong>
                    <p>{comments[`muda-${index}`]}</p>
                  </div>
                )}
                <div className="mt-2">
